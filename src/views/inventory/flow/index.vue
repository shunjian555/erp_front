<template>
  <div class="page-container">
    ...
    <div class="table-toolbar">
      <div class="toolbar-left"><el-button :icon="Download" plain>导出</el-button></div>
...
async function loadData() {
  loading.value = true
  try {
    const res = await (await import('@/utils/request')).default({ url: '/api/inventory/flow/list', method: 'get', params: queryParams })
...
function handleView(row) { ElMessage.info(`查看流水: ${row.flowNo}`) }
onMounted(() => loadData())
</script>
